...
class WindowDemo(QWidget):
    def __init__(self):
        ...
        inputgrouplayout.addWidget(QLabel('输入1'))
...
if __name__ == "__main__":
    ...
    # n3适用于rho算法，是一种平均性能较好的算法，但素数较大时也需要较长时间来处理
    # n3 = 667388241642009445263241687267250527
    # n4用于p-1算法，适用于n有一个因子为光滑数
